...
parser.add_argument('--geneCriteria', type=str, default='variance',
                    help='gene Criteria')
parser.add_argument('--geneSelectnum', type=int, default=350,
...
def preprocessingCSV(dir, datasetName, csvFilename, delim='comma', transform='log', cellRatio=0.99, geneRatio=0.99, geneCriteria='variance', geneSelectnum=350, transpose=False, tabuCol=''):
    '''
